...
const ICONS = {
  ...
  compass: '<circle cx="50" cy="50" r="26" stroke="#23342B" stroke-width="1.6" fill="none"/><path d="M50 50 L62 32 M50 50 L44 66" stroke="#9C4A32" stroke-width="1.6" stroke-linecap="round"/><circle cx="50" cy="50" r="2.5" fill="#23342B"/>',
  ...
  pencil: '<path d="M30 70 L66 34 L74 42 L38 78 L28 80 Z" stroke="#23342B" stroke-width="1.6" stroke-linejoin="round" fill="none"/><line x1="60" y1="40" x2="68" y2="48" stroke="#23342B" stroke-width="1.4"/><circle cx="70" cy="30" r="3" fill="#9C4A32"/><circle cx="60" cy="26" r="3" fill="#BF8B3D"/><circle cx="76" cy="38" r="3" fill="#6B8567"/>',
...
// Vignette d'un produit : la vraie photo si disponible (product.images[0]), sinon l'icône de secours.
function productThumb(product, size){
  ...
  return iconSvg(product.icon, size);
}
